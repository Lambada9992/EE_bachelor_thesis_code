...
auto_scale_lr = dict(base_batch_size=56)
...
model = dict(
    ...
    cfg=dict(
        ...
        neck=dict(type='GlobalAveragePooling'),
        type='ImageClassifier'),
    fix_subnet='my_nas_search/fixed_best_fix_subnet.yaml',
    init_cfg=dict(
        checkpoint='my_nas_search/subnet_20231009_1012.pth',
        prefix='architecture.',
        type='Pretrained'),
